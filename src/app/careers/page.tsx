    ...
    <div className="flex flex-1 flex-col bg-background">
      ...
      <section className="container py-16">
        <div className="grid gap-10 border-y border-border/55 py-10 lg:grid-cols-[0.3fr,0.7fr] lg:items-start">
          <div className="space-y-4">
            <p className="eyebrow">{careers.roadmap.eyebrow}</p>
            <h2 className="heading-2 text-foreground">{careers.roadmap.title}</h2>
          ...
          <div className="space-y-2">
            {careers.hiringProcess.map((step, index) => {
              ...
              return (
                <div
                  key={step.title}
                  className="grid gap-4 border-t border-border/55 py-5 sm:grid-cols-[0.12fr,0.3fr,0.58fr]"
                >
                  <div className="flex items-center gap-3">
                    <span className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10">
                      <Icon className="h-4 w-4 icon-accent" />
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-[0.68rem] uppercase tracking-[0.18em] text-primary">
                      {step.time}
                    </p>
